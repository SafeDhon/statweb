...
class ScoreMobile extends StatefulWidget {
  const ScoreMobile({super.key});

  @override
  State<ScoreMobile> createState() => _ScoreMobileState();
}

class _ScoreMobileState extends State<ScoreMobile> {
